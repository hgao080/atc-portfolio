const Developers = () => {
    return (
        <div className = "flex flex-col items-center justify-center text-white mt-[10rem]">
            <h1 className="font-roboto font-title text-[80px] m-0 ">DEVELOPERS</h1>
            <div className="flex gap-2 items-center mb-[40px]" >
                <div className="font-roboto font-thin mr-[8px] text-[18px]">ATC</div>
                <div className="bg-white mt-[1px] w-[1px] h-[12px]"></div>
                <div className="font-roboto text-[18px] ml-[8px]">OUR TEAM</div>
            </div>
